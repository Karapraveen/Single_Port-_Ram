...
# Generated on: Mon Dec 18 12:06:49 IST 2023 (Mon Dec 18 06:36:49 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/single_port_sync_ram/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/single_port_sync_ram -revised fv_map
...
add_search_path /home/vlsi5/pdk/scl_pdk/stdlib/fs120/liberty/lib_flow_ff -library -both
read_library -liberty -both   /home/vlsi5/pdk/scl_pdk/stdlib/fs120/liberty/lib_flow_ff/tsl18fs120_scl_ff.lib
...
add_search_path /home/vlsi5/praveen_design/single_port_RAM/synthesis -design -golden
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k /home/vlsi5/praveen_design/single_port_RAM/synthesis/single_ram.v
elaborate_design -golden -root {single_port_sync_ram} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/single_port_sync_ram/fv_map.v.gz
elaborate_design -revised -root {single_port_sync_ram}
...
#add_name_alias fv/single_port_sync_ram/fv_map.singlebit.original_name.alias.json.gz -revised
